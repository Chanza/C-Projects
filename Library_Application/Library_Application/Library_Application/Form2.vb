    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox4.Text = TextBox5.Text Then
            ...
            If x = vbYes Then
                ...
                query = New OleDbCommand("insert into Profile1(uname,pword,fname,sname,em,mob,adrs,birth,gender)values('" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox8.Text & "','" & TextBox9.Text & "','" & TextBox10.Text & "','" & DateTimePicker1.Text & "','" & ComboBox1.Text & "')", con)
                con.Open()
